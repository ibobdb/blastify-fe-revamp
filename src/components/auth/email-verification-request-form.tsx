...
type VerificationRequestFormValues = z.infer<typeof verificationRequestSchema>;
...
export function EmailVerificationRequestForm() {
  ...
  const form = useForm<VerificationRequestFormValues>({
  ...
  const onSubmit = async (values: VerificationRequestFormValues) => {
    setIsLoading(true);
